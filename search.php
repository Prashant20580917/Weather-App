...
function setBackgroundImage(cityName) {
    const backgroundImageUrl = "https://source.unsplash.com/1600x900/?" + cityName;
...
if (isset($_POST['submit'])) {
    $search = $_POST['search'];
    echo "setBackgroundImage('$search');";
}
?>
</script>
...
<body>
<form method="post" onsubmit="setBackgroundImage(document.getElementById('search').value);">
</form>
